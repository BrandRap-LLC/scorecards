...
/**
 * Update SEO Channels from MSSQL
...
async function updateSeoChannels() {
  console.log('🔄 Updating SEO Channels from MSSQL');
  console.log('====================================\n');
  ...
  try {
    ...
    console.log('📥 Fetching data from MSSQL seo_channels...');
