...
/**
 * Update Executive Weekly Reports from MSSQL
...
async function updateExecutiveWeekly() {
  console.log('🔄 Updating Executive Weekly Reports from MSSQL');
  console.log('=================================================\n');
  ...
  try {
    ...
    console.log('📥 Fetching data from MSSQL executive_report_new_week...');
    ...
    recentData?.forEach((record, i) => {
      console.log(`  ${i + 1}. ${record.clinic} - ${record.week} - ${record.traffic_source}`);
    });
